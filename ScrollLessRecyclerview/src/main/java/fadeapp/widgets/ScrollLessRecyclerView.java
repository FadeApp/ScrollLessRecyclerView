    ...
    protected void onScrollLeft() {
        ...
        if (layout instanceof LinearLayoutManager) {
            ...
            if (firstVisibleItem.itemView.getMeasuredWidth() > getMeasuredWidth()) {
                super.scrollByInternal(-getMeasuredWidth() + defaultOverflowItemScrollKeep, 0, null);
            } else if (firstVisibleItem.itemView.getMeasuredWidth() == getMeasuredWidth()) {
                super.scrollByInternal(-getMeasuredWidth(), 0, null);
            } else {
                super.scrollByInternal(firstVisibleItem.itemView.getRight() - getMeasuredWidth(), 0, null);
            }
            ...
            super.scrollByInternal(scrollDistance - getMeasuredWidth(), 0, null);
        }
    }
    ...
    protected void onScrollRight() {
        ...
        if (layout instanceof LinearLayoutManager) {
            ...
            if (lastVisibleItem.itemView.getMeasuredWidth() > getMeasuredWidth()) {
                ...
                super.scrollByInternal(lastVisibleItem.itemView.getLeft(), 0, null);
            }
        } else if (layout instanceof StaggeredGridLayoutManager) {
            StaggeredGridLayoutManager realLayout = (StaggeredGridLayoutManager) layout;
            ...
            super.scrollByInternal(scrollDistance, 0, null);
        }
    }
    ...
    protected void onScrollUp() {
        ...
        if (layout instanceof LinearLayoutManager) {
            ...
            if (firstVisibleItem.itemView.getMeasuredHeight() > getMeasuredHeight()) {
                super.scrollByInternal(0, -getMeasuredHeight() + defaultOverflowItemScrollKeep, null);
            } else if (firstVisibleItem.itemView.getMeasuredHeight() == getMeasuredHeight()) {
                super.scrollByInternal(0, -getMeasuredHeight(), null);
            } else {
                super.scrollByInternal(0, firstVisibleItem.itemView.getBottom() - getMeasuredHeight(), null);
            }
        } else if (layout instanceof StaggeredGridLayoutManager) {
            StaggeredGridLayoutManager realLayout = (StaggeredGridLayoutManager) layout;
            int[] firstVisiblePosition = realLayout.findFirstVisibleItemPositions(null);
            ...
            super.scrollByInternal(0, scrollDistance - getMeasuredHeight(), null);
        }
    }
    ...
    protected void onScrollDown() {
        ...
        if (layout instanceof LinearLayoutManager) {
            ...
            if (lastVisibleItem.itemView.getMeasuredHeight() > getMeasuredHeight()) {
                ...
                super.scrollByInternal(0, lastVisibleItem.itemView.getTop(), null);
            }
        } else if (layout instanceof StaggeredGridLayoutManager) {
            StaggeredGridLayoutManager realLayout = (StaggeredGridLayoutManager) layout;
            int[] lastVisiblePosition = realLayout.findLastVisibleItemPositions(null);
            ...
            super.scrollByInternal(0, scrollDistance, null);
        }
    }
